...
namespace TestNotationPolonaise
{
    class Program
    {
        ...
        /// <summary>
        /// Permet de calculer à partir de la notation polonaise
        /// </summary>
        /// <param name="laFormule"></param>
        /// <param name="resultat"></param>
        /// <returns>le resultat du calcul en notation polonaise </returns>
        ...
        static Double Polonaise(String formule)
        {
            ...
            try
            {
                ...
                // boucle tantqu'il ne reste pas q'une seule case
                while (nbCases > 1)
                {
